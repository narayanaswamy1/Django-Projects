...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Authors',
            fields=[
                ('author', models.ForeignKey(db_column='Author_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='checkinbooks.BookAuthors')),
        ...
        migrations.CreateModel(
            name='Fines',
            fields=[
                ('loan', models.ForeignKey(db_column='Loan_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='checkinbooks.BookLoans')),
